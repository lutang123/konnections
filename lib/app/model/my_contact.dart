...
class MyContact {
  ...
  String id, displayName, givenName, familyName, phoneNumber, email;
...
// add factory keyword when implementing a constructor that doesn't always create a new instance of its class
// in our case, if the data is null, we return null rather than an object
  factory MyContact.fromMap(
      Map<String, dynamic> firebaseMap, String documentId) {
    if (firebaseMap == null) {
      return null;
    }
    final String phoneNumber = firebaseMap['phoneNumber'];
    if (phoneNumber == null) {
      return null;
    }
    return MyContact(
      id: documentId,
      displayName: firebaseMap['displayName'],
      givenName: firebaseMap['givenName'],
      familyName: firebaseMap['familyName'],
  ...
  @override
  int get hashCode => hashValues(id, phoneNumber);

  @override
  bool operator ==(other) {
    if (identical(this, other)) return true;
    if (runtimeType != other.runtimeType) return false;
    final MyContact otherContact = other;
    return id == otherContact.id && phoneNumber == otherContact.phoneNumber;
  }

  @override
  String toString() => 'id: $id, phoneNumber: $phoneNumber';
}
...
//   }
//
//   MyContact.fromMap(Map<String, dynamic> m, String documentId) {
//     id = documentId;
...
//   }
//
//   static Map _toMap(MyContact contact) {
//     var emails = [];
